...
func main() {
	...
	maxRequests := int32(2)
	librato := metrics.WithLibrato("librato-operations@smartystreets.com", "417d3fd5dd34621420f1e1871d220bd78f9187652b530b16b4386bcc71ec16d5", "mymachinename", maxRequests)
